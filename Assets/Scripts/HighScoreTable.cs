...
public class HighScoreTable : MonoBehaviour
{
    ...
    private void Update() {
        if (_system.GetButtonDown("Cancel")) {
    ...
    private void CreateHighScoreEntryTransform(string pName, int score, Transform container, ICollection<Transform> transformList) {
        ...
        entryRectTransform.anchoredPosition = new Vector2(_entryTemplate.GetComponent<RectTransform>().anchoredPosition.x,
                                                          -templateHeight * transformList.Count - 20.4f);
